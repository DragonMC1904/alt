...
extends GuiScreen {
    ...
    public void actionPerformed(GuiButton button) throws IOException {
        switch (button.id) {
            ...
            case 2: {
                ...
                AltManager altManager = Dragon.altManager;
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        this.drawString(this.fontRendererObj, "Logged in as " + this.mc.session.getUsername(), 10, 10, -7829368);
        ...
        GL11.glEnable(3089);
        int y2 = 38;
        AltManager altManager2 = Dragon.altManager;
